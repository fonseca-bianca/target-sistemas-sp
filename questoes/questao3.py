...
def processar_faturamento(dados): # recebe 'dados'
    ...
    if not faturamento_dias: # verificar se a lista 'faturamento_dias' está vazia
    ...
    # dias que faturamento diário foi superior à média mensal
    dias_acima_da_media = len([dia for dia in faturamento_dias if dia > media_faturamento])
