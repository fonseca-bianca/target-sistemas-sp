...
# percentual iniciando em zero
percentual_estado = 0

# calcular o faturamento total de todos os estados
total_faturamento = SP + RJ + MG + ES + Outros

# loop pra calcular e exibir o percentual de cada estado. Iteração sobre uma lista de tuplas
# 'estado': 1º valor tupla. 'faturamento': 2º valor da tupla. Ambos recebem os valores durante cada iteração do loop
